...
<TOCInline
  toc={props.toc}
  exclude={[`My Best Web Development and Design Resources for 2025`, 'Table of content']}
/>
...
> [!tip]
> You can find this list in my [github account](https://github.com/shatlyk1011/my-best-frontend-resources), which I update periodically with new links 🙂
