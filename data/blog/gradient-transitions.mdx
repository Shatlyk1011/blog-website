...
draft: false
summary: Creating Smooth Gradient Transitions on :hover using CSS @property rule
...
<br /> <br /> Visit [CanIUse](https://caniuse.com/?search=%40property) to check compatibility
