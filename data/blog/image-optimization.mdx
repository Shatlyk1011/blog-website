---
title: Web Performance - The Art of Image Optimization
date: 2025-12-04
tags: ['performance', 'web development', 'images', 'video', 'code-snippets']
draft: true
summary: Discover expert techniques to compress and optimize images, slashing load times and boosting user experience without sacrificing quality.
---
...
> For server-side integration, send the user's **screen size** so the server. This way, the server can send a smaller or larger image based on the device size
...
### Why next.js build in Image component might be bad choice?
...
_See [browser supports](https://caniuse.com/webp) for `.webp` format._
